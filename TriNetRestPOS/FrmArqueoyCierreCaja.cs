...
// Type: TriNetRestPOS.FrmArqueoyCierreCaja
...
{
  [DesignerGenerated]
  public class FrmArqueoyCierreCaja : Form
  {
    private IContainer components;
    private DateTime dat_InitialDate;
    private DateTime dat_FinalDate;
    private DateTime dtp_DateInitial;
    private DateTime dtp_DateFinal;
    private int int_LocalId;
    private List<BE_TR1_DOCUMENTS> oLista1;
    private List<BE_TR1_DOCUMENTS> oLista2;
    private List<BE_TR1_DOCUMENTS> oLista3;
    private List<BE_TR1_DOCUMENTS> oLista4;
    private List<BE_TR1_DOCUMENTS> oLista5;
    private List<BE_TR1_DOCUMENTS> oLista6;
    private string str_ReportSubTitle;
    private short intCreditos;

    public FrmArqueoyCierreCaja()
    {
      this.Load += new EventHandler(this.FrmArqueoyCierreCaja_Load);
      this.intCreditos = (short) 1;
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (FrmArqueoyCierreCaja));
      ...
      this.Button_CreditosOtorgados = new Button();
      this.Button_VentasHistorico = new Button();
      this.SuspendLayout();
      ...
      this.Label1.Location = new Point(72, 17);
      ...
      this.Label3.Location = new Point(75, 52);
      ...
      this.DateTimePicker_FinalDate.Location = new Point(185, 50);
      ...
      this.MaskedTextBox_InitialHour.TabIndex = 426;
      ...
      this.DateTimePicker_InitialDate.Location = new Point(185, 15);
      ...
      this.MaskedTextBox_FinalHour.TabIndex = 428;
      ...
      this.TextBox_EstabliDes.Location = new Point(98, 91);
      ...
      this.TextBox_EstabliDes.TabIndex = 429;
      ...
      this.TextBox_EstabliId.Location = new Point(368, 54);
      ...
      this.TextBox_EstabliId.TabIndex = 434;
      ...
      this.Button_Establi_Search.Location = new Point(368, 89);
      ...
      this.Button_Establi_Search.TabIndex = 430;
      ...
      this.Label5.Location = new Point(168, 17);
      ...
      this.Label6.Location = new Point(168, 52);
      ...
      this.Label9.Location = new Point(81, 92);
      ...
      this.Button_Detail_Order.Location = new Point(1, 140);
      this.Button_Detail_Order.Margin = new Padding(4, 5, 4, 5);
      this.Button_Detail_Order.Name = "Button_Detail_Order";
      this.Button_Detail_Order.Size = new Size(217, 60);
      this.Button_Detail_Order.TabIndex = 438;
      this.Button_Detail_Order.Text = "[Registro de Ventas]";
      ...
      this.ProgressBar_Report.Location = new Point(35, 20);
      ...
      this.ProgressBar_Report.TabIndex = 441;
      ...
      ((Control) this.SpinningProgress_Report).Location = new Point(174, 73);
      ...
      ((Control) this.SpinningProgress_Report).TabIndex = 439;
      this.SpinningProgress_Report.set_TransistionSegment(7);
      ...
      this.Button_CreditosOtorgados.BackColor = Color.PapayaWhip;
      this.Button_CreditosOtorgados.Font = new Font("Trebuchet MS", 11.25f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      this.Button_CreditosOtorgados.ForeColor = Color.MediumBlue;
      this.Button_CreditosOtorgados.Image = (Image) TriNetRestPOS.My.Resources.Resources.print_printer_s;
      this.Button_CreditosOtorgados.Location = new Point(226, 140);
      this.Button_CreditosOtorgados.Margin = new Padding(4, 5, 4, 5);
      this.Button_CreditosOtorgados.Name = "Button_CreditosOtorgados";
      this.Button_CreditosOtorgados.Size = new Size(217, 60);
      this.Button_CreditosOtorgados.TabIndex = 442;
      this.Button_CreditosOtorgados.Text = "[Créditos Otorgados]";
      this.Button_CreditosOtorgados.TextAlign = ContentAlignment.MiddleRight;
      this.Button_CreditosOtorgados.TextImageRelation = TextImageRelation.ImageBeforeText;
      this.Button_CreditosOtorgados.UseVisualStyleBackColor = false;
      this.Button_VentasHistorico.BackColor = Color.PapayaWhip;
      this.Button_VentasHistorico.Font = new Font("Trebuchet MS", 11.25f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      this.Button_VentasHistorico.ForeColor = Color.MediumBlue;
      this.Button_VentasHistorico.Image = (Image) TriNetRestPOS.My.Resources.Resources.print_printer_s;
      this.Button_VentasHistorico.Location = new Point(111, 206);
      this.Button_VentasHistorico.Margin = new Padding(4, 5, 4, 5);
      this.Button_VentasHistorico.Name = "Button_VentasHistorico";
      this.Button_VentasHistorico.Size = new Size(217, 60);
      this.Button_VentasHistorico.TabIndex = 443;
      this.Button_VentasHistorico.Text = "[Histórico]";
      this.Button_VentasHistorico.TextAlign = ContentAlignment.MiddleRight;
      this.Button_VentasHistorico.TextImageRelation = TextImageRelation.ImageBeforeText;
      this.Button_VentasHistorico.UseVisualStyleBackColor = false;
      this.AutoScaleDimensions = new SizeF(8f, 16f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.BackColor = SystemColors.ControlLightLight;
      this.ClientSize = new Size(450, 272);
      this.Controls.Add((Control) this.SpinningProgress_Report);
      this.Controls.Add((Control) this.Button_VentasHistorico);
      this.Controls.Add((Control) this.Label_Loading);
      this.Controls.Add((Control) this.Button_CreditosOtorgados);
      ...
      this.Name = nameof (FrmArqueoyCierreCaja);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "Arqueo y Cierre Caja";
    ...
    internal virtual Button Button_CreditosOtorgados
    {
      get
      {
        return this._Button_CreditosOtorgados;
      }
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        EventHandler eventHandler = new EventHandler(this.Button_CreditosOtorgados_Click);
        Button creditosOtorgados1 = this._Button_CreditosOtorgados;
        if (creditosOtorgados1 != null)
          creditosOtorgados1.Click -= eventHandler;
        this._Button_CreditosOtorgados = value;
        Button creditosOtorgados2 = this._Button_CreditosOtorgados;
        if (creditosOtorgados2 == null)
          return;
        creditosOtorgados2.Click += eventHandler;
      }
    }

    internal virtual Button Button_VentasHistorico
    {
      get
      {
        return this._Button_VentasHistorico;
      }
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        EventHandler eventHandler = new EventHandler(this.Button_VentasHistorico_Click);
        Button buttonVentasHistorico1 = this._Button_VentasHistorico;
        if (buttonVentasHistorico1 != null)
          buttonVentasHistorico1.Click -= eventHandler;
        this._Button_VentasHistorico = value;
        Button buttonVentasHistorico2 = this._Button_VentasHistorico;
        if (buttonVentasHistorico2 == null)
          return;
        buttonVentasHistorico2.Click += eventHandler;
      }
    }
    ...
    private void FrmArqueoyCierreCaja_Load(object sender, EventArgs e)
    {
      this.LoadDate();
    ...
    private void BackgroundWorker_Report_DoWork(object sender, DoWorkEventArgs e)
    {
      ...
      Thread.Sleep(100);
      BL_TR1_DOCUMENTS blTr1Documents = new BL_TR1_DOCUMENTS();
      if (this.intCreditos == (short) 1)
      {
        this.oLista1 = blTr1Documents.ListadoProductosCierreCaja(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista2 = blTr1Documents.ListadoCreditosyTotalesCierreCaja(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista3 = blTr1Documents.ListadoArqueoPagosCierreCaja(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista4 = blTr1Documents.ListadoCantidadDocumentosCierreCaja(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista5 = blTr1Documents.ListadoCreditosAnuladosyPorCobrarCierreCaja(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista6 = blTr1Documents.ListadoTotalComandasAnuladasEnviadasCierreCaja(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
      }
      else if (this.intCreditos == (short) 2)
        this.oLista1 = blTr1Documents.ListadoCreditosOtorgadosCierreCaja(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
      else if (this.intCreditos == (short) 3)
      {
        this.oLista1 = blTr1Documents.ListadoProductosCierreCajaHistorico(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista2 = blTr1Documents.ListadoCreditosyTotalesCierreCajaHistorico(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista3 = blTr1Documents.ListadoArqueoPagosCierreCajaHistorico(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista4 = blTr1Documents.ListadoCantidadDocumentosCierreCajaHistorico(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista5 = blTr1Documents.ListadoCreditosAnuladosyPorCobrarCierreCajaHistorico(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
        this.oLista6 = blTr1Documents.ListadoTotalComandasAnuladasEnviadasCierreCaja(this.int_LocalId, this.dtp_DateInitial, this.dtp_DateFinal);
      }
      this.BackgroundWorker_Report.ReportProgress(100);
      e.Result = (object) this.oLista1;
    }
      ...
      RunWorkerCompletedEventArgs e)
    {
      try
      {
        ...
        else
        {
          ...
          if (this.intCreditos == (short) 1)
          {
            ModGeneralFunctions.SetUp_Report_Initial_Documents_FechaPiePagina(ref p_ReportDocument, "TR1_REPORT\\rptListadoProductosCierreCaja.rpt", "Cierre de Caja ", this.str_ReportSubTitle, "");
            p_ReportDocument.Database.Tables[0].SetDataSource((IEnumerable) this.oLista1);
            p_ReportDocument.Subreports["rptCreditosyTotalesCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista2);
            p_ReportDocument.Subreports["rptArqueoPagosCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista3);
            p_ReportDocument.Subreports["rptCantidadDocumentosCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista4);
            p_ReportDocument.Subreports["rptListadoCreditosAnuladosyPorCobrarCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista5);
            p_ReportDocument.Subreports["rptTotalComandasEliminadasEnviadasCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista6);
            ModGeneralFunctions.SetUp_Report_Final(ref p_ReportDocument, false, "Cierre de Caja");
          }
          else if (this.intCreditos == (short) 2)
          {
            ModGeneralFunctions.SetUp_Report_Initial_Documents_FechaPiePagina(ref p_ReportDocument, "TR1_REPORT\\rptCreditosOtorgadosCierreCaja.rpt", "Listado de Crédito Otorgados", this.str_ReportSubTitle, "");
            p_ReportDocument.Database.Tables[0].SetDataSource((IEnumerable) this.oLista1);
            ModGeneralFunctions.SetUp_Report_Final(ref p_ReportDocument, false, "Listado de Crédito Otorgados");
          }
          else if (this.intCreditos == (short) 3)
          {
            ModGeneralFunctions.SetUp_Report_Initial_Documents_FechaPiePagina(ref p_ReportDocument, "TR1_REPORT\\rptListadoProductosCierreCaja.rpt", "Cierre de Caja Histórico", this.str_ReportSubTitle, "");
            p_ReportDocument.Database.Tables[0].SetDataSource((IEnumerable) this.oLista1);
            p_ReportDocument.Subreports["rptCreditosyTotalesCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista2);
            p_ReportDocument.Subreports["rptArqueoPagosCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista3);
            p_ReportDocument.Subreports["rptCantidadDocumentosCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista4);
            p_ReportDocument.Subreports["rptListadoCreditosAnuladosyPorCobrarCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista5);
            p_ReportDocument.Subreports["rptTotalComandasEliminadasEnviadasCierreCaja.rpt"].SetDataSource((IEnumerable) this.oLista6);
            ModGeneralFunctions.SetUp_Report_Final(ref p_ReportDocument, false, "Cierre de Caja Histórico");
          }
        }
      }
      catch (Exception ex)
    ...
    private void Button_CreditosOtorgados_Click(object sender, EventArgs e)
    {
      this.intCreditos = (short) 2;
      if (this.ValidateText())
        return;
      this.Get_Parameter();
      this.Select_Values();
    ...
    private void Button_VentasHistorico_Click(object sender, EventArgs e)
    {
      this.intCreditos = (short) 3;
      if (this.ValidateText())
        return;
      this.Get_Parameter();
      this.Select_Values();
